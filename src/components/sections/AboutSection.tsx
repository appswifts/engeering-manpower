        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-gray-600 mb-6">
              Since 2022, EMP Engineering Manpower Providers has established a premier reputation for excellence in technical services. Our expertise spans the provision of skilled engineering talent, technical training, consulting services, and project management.
            </p>
